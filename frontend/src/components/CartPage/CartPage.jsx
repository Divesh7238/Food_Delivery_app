      ...
      <div className="max-w-7xl mx-auto">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center animate-fade-in">
            ...
            <Link
              to="/menu"
              className="bg-amber-900/40 px-6 py-2 rounded-full font-cinzel text-sm uppercase transition-all duration-300 text-amber-100 inline-flex items-center gap-2 hover:gap-3 hover:bg-amber-800/50"
            >
              Browse All Items
            </Link>
          </div>
              ...
              {cartItems.map((item) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <FaMinus className="w-4 h-4 text-amber-100 font-cinzel" />
                    </button>
                  ...
                  <div className="flex items-center justify-between w-full">
                    ...
                    <p className="text-sm font-dancingscript text-amber-300">${item.price * item.quantity}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        {selectedImage && (
          ...
          >
            <div className="relative max-w-full max-h-full">
              ...
              <button
                onClick={() => setSelectedImage(null)}
                className="absolute top-1 right-1 bg-amber-900/80 rounded-full p-2 text-black hover:bg-amber-800/80 transition-all duration-200 active:scale-90"
              >
